...
#- Run Wilcoxon using zyBook Participation Activity 3.3.4 data:

if __name__ == "__main__":
    a  = np.array([9.84,9.40,8.20,8.24,9.20,8.55,8.52,8.12])       #Asian
    c1 = np.array([8.27,8.20,8.25,8.14,9.00,8.10,7.20,8.32,7.70])  #Caucasian

    print("Wilcoxon using zyBook Participation Activity 3.3.4 data:")
    wilcoxon(a, c1, diag=True)


#- Run Wilcoxon using Wild Example 1 data:

if __name__ == "__main__":
    na = np.array([8.50,9.48,8.65,8.16,8.83,7.76,8.63])      #Native American
    c2 = np.array([8.27,8.20,8.25,8.14,9.00,8.10,7.20,8.32,7.70])  #Caucasian

    print("Wilcoxon using Wild Example 1 data:")
    wilcoxon(na, c2, diag=True)
